...
if __name__ == '__main__':
  ...
  parser.add_argument("--pose", help="Pose Type argument")
  ...
  if args.pose:
      print("Pose Type:", args.pose)
      class_name=args.pose
  else:
      print("Pose Type not provided.")  
  ...
  out_video_path = video_path.split('.')[0] + '_out.' + video_path.split('.')[1]
  ...
  pose_samples_folder = 'fitness_poses_csvs_out' #Folder with pose class CSVs
  pose_classifier = PoseClassifier(
